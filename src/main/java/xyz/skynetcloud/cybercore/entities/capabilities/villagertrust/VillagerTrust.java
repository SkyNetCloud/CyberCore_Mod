...
public class VillagerTrust implements IVillagerTrust, ICapabilitySerializable<CompoundNBT> {

	@CapabilityInject(IVillagerTrust.class)
	public static Capability<IVillagerTrust> INSTANCE = null;

	private final List<String> keys = ImmutableList.of("scientist");
	...
	private final LazyOptional<IVillagerTrust> lazyoption = LazyOptional.of(() -> this);

	public VillagerTrust() {
		for (String key : keys) {
			trust.put(key, 0);
		}
	}

...
public class ItemInSystemWrapper {
    ...
    public ItemInSystemWrapper(ItemStack stack, Queue<Direction> moves, int ticksToTravel) {
    ...
    public ItemInSystemWrapper(ItemStack stack, Queue<Direction> moves, int ticksToTravel, Direction firstMove) {
    ...
    public static ItemInSystemWrapper readFromNBT(CompoundTag compound) {
        ...
        ItemInSystemWrapper wrapper = new ItemInSystemWrapper(stack, decompressMoveList(moveBuffer), maxDuration);
    ...
    public static IntArrayTag compressMoveList(Queue<Direction> moves) {
        ...
        IntArrayTag tag = new IntArrayTag(buffer);

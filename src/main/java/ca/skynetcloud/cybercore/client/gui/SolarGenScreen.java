...
public class SolarGenScreen extends ScreenBaseCore<SolarGenMenu>{

    private static final ResourceLocation TEXTURES = new ResourceLocation(
            CyberCore.MODID + ":textures/gui/container/solorgen.png");

    public SolarGenScreen(SolarGenMenu container, Inventory inv, Component name) {

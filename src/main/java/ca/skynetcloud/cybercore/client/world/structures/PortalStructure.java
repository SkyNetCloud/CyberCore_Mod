package ca.skynetcloud.cybercore.client.world.structures;

import ca.skynetcloud.cybercore.client.init.MainInit;
import ca.skynetcloud.cybercore.client.world.dimensions.MysteriousChunkGenerator;
...
public class PortalStructure extends Structure {
    ...
    public PortalStructure(StructureSettings config,

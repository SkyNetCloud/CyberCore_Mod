...
public class CyberArmor extends ArmorItemBase {
	...
	public void onArmorTick(ItemStack stack, Level world, Player player) {
		...
		if (player.getItemBySlot(EquipmentSlot.HEAD).getItem() == MainInit.CYBER_HELMET.get().asItem()
				&& player.getItemBySlot(EquipmentSlot.CHEST).getItem() == MainInit.CYBER_CHESTPLATE.get().asItem()
				&& player.getItemBySlot(EquipmentSlot.LEGS).getItem() == MainInit.CYBER_LEGGINGS.get().asItem()
				&& player.getItemBySlot(EquipmentSlot.FEET).getItem() == MainInit.CYBER_BOOTS.get().asItem()) {

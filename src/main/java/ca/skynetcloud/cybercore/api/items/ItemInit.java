...
public class ItemInit {
	...
	public static Item speed_upgrade_card_1 = new UpgradeLvl(new Item.Properties().tab(CyberCoreTab.instance), 1,
			ItemType.SPEED_UPGRADE).setRegistryName(SPEED_CARD_1);

	public static Item speed_upgrade_card_2 = new UpgradeLvl(new Item.Properties().tab(CyberCoreTab.instance), 2,
			ItemType.SPEED_UPGRADE).setRegistryName(SPEED_CARD_2);

	public static Item speed_upgrade_card_3 = new UpgradeLvl(new Item.Properties().tab(CyberCoreTab.instance), 3,
			ItemType.SPEED_UPGRADE).setRegistryName(SPEED_CARD_3);

	public static Item speed_upgrade_card_4 = new UpgradeLvl(new Item.Properties().tab(CyberCoreTab.instance), 4,
	...
	public static Item CYBER_HELMET = new ArmorItemBase(CustomArmorMaterial.Cyber_Ingot, "cyber",
			EquipmentSlotType.HEAD, new Item.Properties().tab(CyberCoreTab.instance).rarity(Rarity.RARE))
	...
	public static Item CYBER_LEGGINGS = new ArmorItemBase(CustomArmorMaterial.Cyber_Ingot, "cyber",
			EquipmentSlotType.LEGS, new Item.Properties().tab(CyberCoreTab.instance).rarity(Rarity.RARE))

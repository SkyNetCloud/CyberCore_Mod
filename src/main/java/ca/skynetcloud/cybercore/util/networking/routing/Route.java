...
public class Route implements Comparable<Route> {
	...
	public int length; // this isn't the same as the size of the sequence because tubes could have
						// unusual length
	...
	public boolean isRouteDestinationValid(World world, BlockPos startPos, Direction insertionSide, ItemStack stack) {
		// if the route's endpoint was the position/face the item was inserted from,
		// this route is not valid
		if (this.destination.pos.equals(startPos.offset(insertionSide))) {
			return false;
		}

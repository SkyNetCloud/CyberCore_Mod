...
public abstract class ScreenBaseCore<T extends BaseContainerCore> extends ContainerScreen {
	...
	public final CoreEnergyTileEntity te;
...
//	        this.renderHoveredToolTip(mStack, mouseX, mouseY);
	...
	protected void renderTooltip(PoseStack mStack, int x, int y) {
		if (minecraft.player.inventoryMenu.getCarried().isEmpty() && this.hoveredSlot != null
			...
			this.renderTooltip(mStack, new TextComponent(((SlotItemHandlerWithInfo) this.hoveredSlot).getUsageString()),
					x, y);
		else

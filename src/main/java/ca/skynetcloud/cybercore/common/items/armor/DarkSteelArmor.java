...
public class DarkSteelArmor extends ArmorItemBase {
	...
	public void onArmorTick(ItemStack stack, Level world, Player player) {
		if (player.getItemBySlot(EquipmentSlot.HEAD).getItem() == ItemInit.DARK_STEEL_HELMET.get().asItem()
				&& player.getItemBySlot(EquipmentSlot.CHEST).getItem() == ItemInit.DARK_STEEL_CHESTPLATE.get().asItem()
				&& player.getItemBySlot(EquipmentSlot.LEGS).getItem() == ItemInit.DARK_STEEL_LEGGINGS.get().asItem()
				&& player.getItemBySlot(EquipmentSlot.FEET).getItem() == ItemInit.DARK_STEEL_BOOTS.get().asItem()) {

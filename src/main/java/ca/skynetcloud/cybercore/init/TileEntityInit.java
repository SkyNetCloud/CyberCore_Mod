...
public class TileEntityInit {
	...
	public static final BlockEntityType<PowerCablesTileEntity> Cable = null;
	...
	public static void registerTileEntities(RegistryEvent.Register<TileEntityType<?>> event) {
		...
		event.getRegistry().register(
				BlockEntityType.Builder.of(PowerCablesTileEntity::new, tubes).build(null).setRegistryName(Names.CABLE));
	}

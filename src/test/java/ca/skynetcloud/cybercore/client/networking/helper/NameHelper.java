...
public class NameHelper {
	...
	public static final String COLORCHANGERCONTAINER = MODID + ":colorchangercontainer";
	public static final String POWERCUBECONTAINER = MODID + ":powercubecontainer";
	public static final String POWEREDFURNACECONTAINER = MODID + ":poweredfurnacecontainer";
